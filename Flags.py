...
flags.mcmc_initial_offset =  #was in Niel's code, must ask if this is inherited or needs initialisation
flags.mcmc_initial_stddev =  #was in Niel's code, must ask if this is inherited or needs initialisation
...
flags.fnn_electron_positions =
flags.fnn_nuclei_positions =
flags.fnn_n_up =
flags.fnn_L =
flags.fermilayer_h_in_dims =
flags.fermilayer_h_out_dims =
...
original_flags.mcmc_initial_offset =  #was in Niel's code, must ask if this is inherited or needs initialisation
original_flags.mcmc_initial_stddev =  #was in Niel's code, must ask if this is inherited or needs initialisation
...
there may be crossover with some of the original_flags already
 present so only some alterations would be required"""
original_flags.fnn_electron_positions =
original_flags.fnn_nuclei_positions =
original_flags.fnn_n_up =
original_flags.fnn_L =
original_flags.fermilayer_h_in_dims =
original_flags.fermilayer_h_out_dims =
...
there may be crossover with some of the original_flags already
 present so only some alterations would be required"""
original_flags.atoms =
original_flags.nelectrons = 
original_flags.potential_epsilon = 
original_flags.x =
original_flags.xs =
